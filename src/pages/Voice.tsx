...
const Voice = () => {
  ...
  if (loading) {
    return <div className="min-h-screen bg-[#6DAEDB] flex flex-col items-center py-12 px-4 pt-20 pb-24 text-black font-sans">
  ...
  return <div className="min-h-screen bg-[#6DAEDB] flex flex-col items-center py-12 px-4 pt-20 pb-24 text-black font-sans">
      <div className="w-full max-w-[390px] h-[500px] max-h-[60vh]">
        {user ? <RealtimeChat /> : <div className="h-full flex flex-col items-center justify-center text-center">
            ...
            <p className="text-attune-purple/80 mb-6">Attune remembers conversations, and keeps them secret, so you can always pick up where you left off — or not.</p>
