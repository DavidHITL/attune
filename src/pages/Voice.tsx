...
const Voice = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-attune-deep-blue flex flex-col items-center py-12 px-4 pt-20 pb-24">
      ...
      <div className="w-full max-w-[390px] h-[500px] max-h-[60vh]">
        {user ? (
          ...
          <div className="h-full flex flex-col items-center justify-center text-center">
            ...
            <Link to="/auth" className="bg-[#33C3F0] text-white px-6 py-2 rounded-full hover:bg-[#1EAEDB] transition-colors font-sans inline-block">
              Sign In
            </Link>
          </div>
        )}
