...
const AttuneContent = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full w-full bg-attune-deep-blue">
        ...
        <div className="mb-8">
          ...
          {!user ? (
            <div className="mt-8">
              <Link
                to="/auth" 
                className="bg-white text-attune-deep-blue px-6 py-2 rounded-full hover:bg-gray-100 transition-colors font-sans inline-block"
              >
                Sign In
              </Link>
            </div>
