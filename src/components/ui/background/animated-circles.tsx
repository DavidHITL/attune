...
export const AnimatedCircles = ({ variant }: AnimatedCirclesProps) => {
    ...
    const circleSize = isGrayVariant ? "h-[420px] w-[420px]" : "h-[240px] w-[240px]";
                    ...
                    <div
                        className={cn(
                            ...
                            variant === "rainbow" 
                              ...
                              : isGrayVariant
                              ? "bg-[radial-gradient(ellipse_at_center,rgba(255,255,255,0.25),transparent_70%)]"
